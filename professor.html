...
<body>
    ...
    <script>
       ...
       var buttons = `<form id="filters"><label for="difficulty">Difficulty</label>
            ...
            <button onclick="" id ="filterbutton" type="button" form="filters" value="Submit">Filter</button></form>`;
        ...
        var buttons2 = `<form id="filters"><label for="difficulty">Difficulty</label>
             ...
             <label for="search">Search</label>
             <input type="search" id="searchfilter" name="search">
             <button onclick="" id ="filterbutton2" type="button" form="filters" value="Submit">Filter</button></form>`;
