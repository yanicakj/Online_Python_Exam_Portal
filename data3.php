<?php
	...
	$table = "<table border='1' width='100%' id='bank' style='font-size:50%'><tr><td>#</td><td>Description</td><td>Difficulty</td><td>Category</td></tr>";
	...
	$table = $table . "</table><br><br><br><br>"; //. "<br><button id='addtoexam' class=\"btn\" type=\"button\">Add to Exam</button><br<br><br><br>";
	...
	$myfile = fopen("button1contentv2.txt", "r") or die("Unable to open file!");
	// BUTTON TO ADD TO QUESTION BANK
	$contents = fread($myfile,filesize("button1contentv2.txt"));
	fclose($myfile);
